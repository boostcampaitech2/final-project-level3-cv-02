...
class Network:
    ...
    def _init_graph(self) -> None:
        ...
        with tf.name_scope(None):
            self.scope = tf.compat.v1.get_default_graph().unique_name(
        ...
        with tfutil.absolute_variable_scope(
            ...
            with tf.control_dependencies(
                ...
                self.input_templates = [
                    tf.compat.v1.placeholder(tf.float32, name=name)
        ...
        self.own_vars = OrderedDict(
            ...
            for var in tf.compat.v1.global_variables(self.scope + "/")
        )
    ...
    def copy_compatible_trainables_from(self, src_net: "Network") -> None:
        ...
        for name in self.trainables.keys():
            ...
            if (
                ...
                and self.trainables[name].shape == src_net.trainables[name].shape
            ):
                names.append(name)
