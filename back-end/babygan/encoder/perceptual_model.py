...
class PerceptualModel:
    ...
    def add_placeholder(self, var_name):
        ...
        setattr(
            ...
            tf.compat.v1.placeholder(var_val.dtype, shape=var_val.get_shape()),
        )
        setattr(
            self,
            var_name + "_op",
    ...
    def build_perceptual_model(self, generator, discriminator=None):
        ...
        generated_image = tf.compat.v1.image.resize_nearest_neighbor(
    ...
    def generate_face_mask(self, im):
        ...
        for (j, rect) in enumerate(rects):
            ...
            if self.use_grabcut:
                ...
                cv2.grabCut(
                    im, mask, rect, bgdModel, fgdModel, 5, cv2.GC_INIT_WITH_MASK
                )
